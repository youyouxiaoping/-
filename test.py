...
def get_dv(start = 20170101,end = 20180101):
    ...
    dataview_folder = r'E:\股票因子数据\HelloGit-master\Internship_Factor\data'
...
import AD, alpha28, DownRVI,InventoryTDays,TaxRatio,MoneyFlow20,PBIndu,NetNonOIToTPLatest

for f in ['AD', 'alpha28', 'DownRVI','InventoryTDays','TaxRatio','MoneyFlow20','NetNonOIToTPLatest','PBIndu']:
